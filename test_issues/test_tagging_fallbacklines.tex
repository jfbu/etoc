...
% The next triggers the package "fallback" line styles for TOC
% This should have been named \etocfallbacklines and probably
% this alias will be provided in future
\etocdefaultlines
